...
class ChatwGifted extends Component {
  ...
  sendRemoteNotification(data) {
    ...
    fetch(url+'/api/sendNotification',{method:"POST",body:JSON.stringify(body),headers: { "Content-Type": "application/json" }})
    .then(res=>res.json())
    .then(data=>{
      console.log(data)
          ...
          return (
            ...
            >
                <View style={{marginRight: 10, marginBottom: 10}}>
                  <Text style={{color:'darkred',fontWeight:'bold'}}>Send</Text>
                </View>
            </Send>
        );
        }}

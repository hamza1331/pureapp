...
/>
      ...
      <View style={{width:'100%',height:hp('11%'),backgroundColor:'white',flexDirection:'row',justifyContent:'space-evenly',flexWrap:'wrap',marginBottom:10}}>
      <CheckBox
  title='National'
...
/>
  ...
  <TouchableOpacity disabled={this.state.uploading} onPress={this.uploadImages} style={{width:wp('90%'),height:hp('4%'),backgroundColor:'darkred',borderRadius:15,alignItems:'center',justifyContent:'center'}}>
    {this.state.uploading===false && <Text style={{color:'white',fontSize:20}}>Publish</Text>}
    {this.state.uploading===true && <ActivityIndicator size={Platform.OS==='android'?10:0} animating color='white'/>}
  </TouchableOpacity>
  </View>
        </ScrollView>
          </SafeAreaView>

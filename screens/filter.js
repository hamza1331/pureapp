      ...
      <SafeAreaView style={{ flex: 1, backgroundColor: '#F3F3F2' }}>
        ...
        <Input
          ...
          <View style={{ marginTop: 25, borderBottomColor: 'white', borderBottomWidth: 2, paddingBottom: 10 }}>
            <Text style={{ marginLeft: 20, fontSize: 25, fontWeight: 'bold', color: 'darkred' }}>Your budget</Text>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
              <Text style={{ marginLeft: 20, fontSize: 20, fontWeight: 'bold', color: 'darkred' }}>${this.state.multiSliderValue[0]} </Text>

              <Text style={{ marginRight: 20, fontSize: 20, fontWeight: 'bold', color: 'darkred' }}>${this.state.multiSliderValue[1]}</Text>
            </View>
            <MultiSlider
              values={[
          ...
          <View style={{ marginTop: 25, borderBottomColor: 'white', borderBottomWidth: 2, paddingBottom: 10 }}>
            <Text style={{ marginLeft: 20, fontSize: 25, fontWeight: 'bold', color: 'darkred' }}>What else?</Text>
            <View style={{ alignItems: 'center', justifyContent: 'space-around', flexDirection: 'row' }}>
               <View>
                <Icon name={this.state.deliverable===true?'car-pickup':'clear'}
                  ...
                  color='darkred' />
                <Text style={{ color: 'darkred' }}>Deliverable</Text>
               ...
               <View>
                <Icon name={this.state.deliverable===false? 'check':'clear'}
                  ...
                  color='darkred' />
                <Text style={{ color: 'darkred' }}>Pickup only</Text>
              ...
              <View>
                <Icon name={this.state.trade===true?'check':'ios-git-compare'}
                  ...
                  color='darkred' />
                <Text style={{ color: 'darkred' }}>Accept Trade?</Text>

              </View>
            </View>
          </View>
          <View style={{ marginTop: 25, borderBottomColor: 'white', borderBottomWidth: 2, paddingBottom: 10 }}>
            <Text style={{ marginLeft: 20, fontSize: 25, fontWeight: 'bold', color: 'darkred' }}>Publication date</Text>
            <View style={{ alignItems: 'center', justifyContent: 'space-around', flexDirection: 'row' }}>
              <View onTouchEnd={()=>{
                this.setState({
                  days:1,
                ...
                <Text style={{ fontSize: this.state.days===1?30:20, color: 'darkred', fontWeight: 'bold', alignSelf: 'center' }}>24</Text>
                <Text style={{ color: 'darkred',textDecorationLine:this.state.days===1?'underline':'none',fontWeight:this.state.days===1?'bold':'normal' }}>Hours</Text>
              ...
              <View onTouchEnd={()=>{
                ...
                <Text style={{ fontSize: this.state.days===7?30:20, color: 'darkred', fontWeight: 'bold', alignSelf: 'center' }}>7</Text>
                
                <Text style={{ color: 'darkred',textDecorationLine:this.state.days===7?'underline':'none',fontWeight:this.state.days===7?'bold':'normal' }}>Days</Text>
              ...
              <View onTouchEnd={()=>{
                ...
                <Text style={{ fontSize: this.state.days===30?30:20, color: 'darkred', fontWeight: 'bold', alignSelf: 'center' }}>30</Text>
                <Text style={{ color: 'darkred',textDecorationLine:this.state.days===30?'underline':'none',fontWeight:this.state.days===30?'bold':'normal' }}>Days</Text>
              ...
              <View onTouchEnd={()=>{
                ...
                <Text style={{ fontSize: this.state.days===90?30:20, color: 'darkred', fontWeight: 'bold', alignSelf: 'center' }}>90</Text>
                <Text style={{ color: 'darkred',textDecorationLine:this.state.days===90?'underline':'none',fontWeight:this.state.days===90?'bold':'normal' }}>Days</Text>
              </View>
            </View>
          </View>
          <View style={{ marginTop: 25, borderBottomColor: 'white', borderBottomWidth: 2, paddingBottom: 10 }}>
            <Text style={{ marginLeft: 20, fontSize: 25, fontWeight: 'bold', color: 'darkred' }}>Search By Distance</Text>
            <View style={{ alignItems: 'center', justifyContent: 'space-around', flexDirection: 'row' }}>
              <View onTouchEnd={()=>{
                this.setState({
                  distance:50
                ...
                <Text style={{ fontSize: 20, color: 'darkred', fontWeight: 'bold', alignSelf: 'center' }}>50</Text>
                <Text style={{ color: 'darkred',textAlign:'center' }}>Miles</Text>
              </View>
              <View onTouchEnd={()=>{
                this.setState({
                  distance:100
                ...
                <Text style={{ fontSize: 20, color: 'darkred', fontWeight: 'bold', alignSelf: 'center' }}>100</Text>
                <Text style={{ color: 'darkred',textAlign:'center' }}>Miles</Text>
              ...
              <View onTouchEnd={()=>{
                ...
                <Text style={{ fontSize: 20, color: 'darkred', fontWeight: 'bold', alignSelf: 'center' }}>200</Text>
                <Text style={{ color: 'darkred',textAlign:'center' }}>Miles</Text>
              ...
              <View onTouchEnd={()=>{
                ...
                <Text style={{ fontSize: 20, color: 'darkred', fontWeight: 'bold', alignSelf: 'center' }}>400</Text>
                <Text style={{ color: 'darkred',textAlign:'center' }}>Miles</Text>

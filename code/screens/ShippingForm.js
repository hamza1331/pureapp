 ...
 class ShippingForm extends Component {
   ...
   <SafeAreaView style={{flex:1}}>
     ...
     />
       ...
       centerComponent={{ text: 'Shipping Profile', style: { color: '#B46617',fontSize:20,marginBottom:10} }}
    ...
    <View style={{marginTop:25,marginLeft:15}}>
               <Text style={{color:'darkorange',fontSize:30}}>{this.state.title!==''?this.state.title:'Create Shipping Profile'}</Text>
             </View>
